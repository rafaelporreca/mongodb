...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"), "Partiu viajem", "Vou viajar para SP",maria);
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Bom dia todos",maria);
